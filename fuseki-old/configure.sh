...
#curl -X POST -H Content-Type:text/turtle -T /opt/registered-organization.ttl -G http://fuseki:3030/TOOP/data --data-urlencode graph=http://fuseki/TOOP/data/registered-organization
